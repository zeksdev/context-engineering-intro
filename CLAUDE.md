...
- **Always use the latest stable version of NuGet packages**. If you need to use a preview version, please ask me first.
- **Always name files, classes, members in English. English is only an allowed language**
